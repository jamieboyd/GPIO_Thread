...
static const unsigned int PWM_UPDATE_FREQ = 100E03; // 				the PWM output is updated at this frequency, with data from FIFO
...
static const unsigned int PWM_RANGE = 500; //					data for sine wave ranges from 0 to PWM_RANGE - 1
...
base class is PWM_thread. Modified to continuously output a sine wave of user-set frequency, from 1Hz to 25 KHz, in steps of 1 Hz
last modified:
