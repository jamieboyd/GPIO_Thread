...
class SimpleGPIO_thread : public pulsedThread{
	...
	SimpleGPIO_thread  (unsigned int delayUsecs, unsigned int durUsecs, unsigned int nPulses, void * initData, int (*initFunc)(void *, void *  &), void (* loFunc)(void *, unsigned int), void (*hiFunc)(void *, unsigned int), int accLevel , int &errCode) : pulsedThread (delayUsecs, durUsecs, nPulses, initData, initFunc, loFunc, hiFunc, accLevel,errCode) {};
	SimpleGPIO_thread  (float frequency, float dutyCycle, float trainDuration, void * initData, int (*initFunc)(void *, void *  &), void (* loFunc)(void *, unsigned int), void (*hiFunc)(void *, unsigned int), int accLevel , int &errCode) : pulsedThread (frequency, dutyCycle, trainDuration, initData, initFunc, loFunc, hiFunc, accLevel,errCode) {};
